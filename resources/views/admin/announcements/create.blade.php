                    ...
                    <form action="{{ route('admin.announcements.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="content" rows="6"
                                      class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-white focus:border-indigo-500 focus:ring-indigo-500 @error('content') border-red-500 @enderror">{{ old('content') }}</textarea>
                            @error('content')
                                <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
