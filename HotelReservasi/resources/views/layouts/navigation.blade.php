            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center relative">
                    ...
                    @if (Auth::user() && Auth::user()->role === 'user')
                        <x-nav-link :href="route('reservasi.create')" :active="request()->routeIs('reservasi.create')">
                            Pesan Kamar
                        </x-nav-link>
                        <x-nav-link :href="route('status.reservasi')" :active="request()->routeIs('status.reservasi')">
                            {{ __('Status Pemesanan') }}
                        </x-nav-link>
                    @endif
